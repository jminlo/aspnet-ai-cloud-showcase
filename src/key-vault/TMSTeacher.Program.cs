    ...
    .AddMicrosoftIdentityWebApp(options =>
    {
        ...
        options.Events.OnRedirectToIdentityProviderForSignOut = context =>
        {
            ...
            context.ProtocolMessage.PostLogoutRedirectUri =
                $"{baseUrl}/Teacher/signout-callback-oidc";
            return Task.CompletedTask;
        };

        options.Events.OnSignedOutCallbackRedirect = context =>
        {
            context.Response.Redirect("/Teacher/Home/Login");
...
builder.Services.AddHttpClient<IGeminiToySuggestionService, GeminiToySuggestionService>();

// Register GraphAPIService as singleton since it uses GraphServiceClient
